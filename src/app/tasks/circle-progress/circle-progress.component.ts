// Source: https://github.com/Feridum/angular2-circle-progress/blob/master/src/app/circle-progress/circle-progress.component.ts

import { Component, OnInit, Input, AfterContentInit } from '@angular/core';

@Component({
  selector: 'kt-circle-progress',
  templateUrl: './circle-progress.component.html'
})
export class CircleProgressComponent implements OnInit, AfterContentInit {
  ...
  @Input() animateOnLoad:boolean = false;
